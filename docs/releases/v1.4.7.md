...
- **Release recovery**: already-published artifacts are handled as successful recovery cases rather than failures.
...
- **Graceful "already exists" handling** in publish recovery — non-zero exit is ignored when the error message indicates the version is already published
