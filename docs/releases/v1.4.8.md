...
Historical note: this release predated the `vscode-arkive` VSIX distribution path. Current VS Code installs should use the `vscode-arkive.vsix` asset attached to the latest GitHub Release.
