...
describe('detection', () => {
  ...
  it('preserves task detection inside a composite repository worktree path', () => {
    const result = detectContext('/repo/.hive/.worktrees/03_indexed-feature/01-task/repos/api');
